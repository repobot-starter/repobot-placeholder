...
Client-only vertical pack: Style, a timed dress-to-impress fashion game (emoji dress-up doll, runway judging, WebAudio glam synth) at `web/app/src/View/Games/Style/`.
