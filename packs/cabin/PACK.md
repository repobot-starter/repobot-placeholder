...
Client-only vertical pack: Cabin, a flight-attendant time-management game (DOM cabin scene, WebAudio chimes, special-event passengers) at `web/app/src/View/Games/Cabin/`.
