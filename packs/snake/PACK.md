...
Client-only vertical pack: grid Snake (canvas game loop, level progression, localStorage high scores) at `web/app/src/View/Games/Snake/`.

## What ships

- Monochrome game page with score/level/high-score panels (owns `/` when this pack is active; otherwise preview at `/snake`)
