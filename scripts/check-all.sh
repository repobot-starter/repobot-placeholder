...
# Every contentContract slot must read and write in its module and in every
# remix seed composed over it, or the Content panel shows a dead row.
log "Verifying content contracts resolve in their modules..."
node scripts/verify-content-readiness.mjs
