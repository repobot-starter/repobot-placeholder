...
public struct UserFields: AppGraphqlApi.SelectionSet, Fragment {
  public static var fragmentDefinition: StaticString {
    #"fragment UserFields on User { __typename id email displayName status createdTime avatarUploadId account { __typename id name } }"#
  }
  ...
  public static var __selections: [ApolloAPI.Selection] { [
    ...
    .field("avatarUploadId", AppGraphqlApi.Id?.self),
