...
struct ChimneyGameView: View {
  ...
  @State private var bestScore = DeviceStorage.readNumber(key: ChimneyEngine.highScoreKey, fallback: 0)
    ...
    VStack(spacing: theme.spacing.md) {
      ...
      ChimneyFieldView(
        ...
        onEnding: { score in
          ...
          if score > bestScore {
            bestScore = score
            DeviceStorage.writeNumber(key: ChimneyEngine.highScoreKey, value: score)
          }
        }
      )
