...
struct StyleGameView: View {
  ...
  @State private var bestScore = DeviceStorage.readNumber(key: StyleWardrobe.bestScoreKey, fallback: 0)
  ...
  private func dismissVerdict() {
    ...
    if engine.phase == .seasonOver, engine.seasonTotal > bestScore {
      ...
      DeviceStorage.writeNumber(key: StyleWardrobe.bestScoreKey, value: engine.seasonTotal)
    }
  }
