...
struct RaceGameView: View {
  ...
  @State private var bestScore = DeviceStorage.readNumber(key: RaceEngine.highScoreKey, fallback: 0)
    ...
    VStack(spacing: theme.spacing.md) {
      ...
      RaceFieldView(
        ...
        onCrash: { score in
          ...
          if score > bestScore {
            bestScore = score
            DeviceStorage.writeNumber(key: RaceEngine.highScoreKey, value: score)
          }
        }
      )
