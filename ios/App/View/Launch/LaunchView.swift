...
struct LaunchView: View {
  ...
  private var hero: some View {
    VStack(spacing: 18) {
      ...
      if joinedEmail.isEmpty {
        ...
        Text("You're on the list — I'll glow extra bright the day you're up.")
  ...
  private var featureSection: some View {
    VStack(spacing: 14) {
      sectionHeader(kicker: "Features", title: "Everything you need — plus the puns")
  ...
  private var stepsSection: some View {
    VStack(spacing: 14) {
      sectionHeader(kicker: "How it works", title: "Three steps to fully lit")
  ...
  private var pricingSection: some View {
    VStack(spacing: 16) {
      sectionHeader(kicker: "Pricing", title: "The lamp is yours. The puns are a plan.")
  ...
  private var faqSection: some View {
    VStack(spacing: 12) {
      sectionHeader(kicker: "FAQ", title: "Asked at 2 a.m.")
