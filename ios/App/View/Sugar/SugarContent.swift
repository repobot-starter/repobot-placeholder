...
enum SugarContent {
  ...
  struct Machine {
    ...
    let spot: String
    let note: String?
    let schedule: SugarFreshness.MachineSchedule
  }

  static let name = "The Sugar Bin"
  static let tagline = "Fresh pastries from a little pink machine."
  static let story =
  ...
  static let machines: [Machine] = [
    Machine(
      ...
      schedule: SugarFreshness.MachineSchedule(
    ...
    Machine(
      ...
      schedule: SugarFreshness.MachineSchedule(
        stockedDays: [0, 1, 2, 3, 4, 5, 6], restockMinute: 6 * 60, selloutMinute: 15 * 60)),
    Machine(
      name: "Tech Row",
    ...
    Machine(
      ...
      schedule: SugarFreshness.MachineSchedule(
        stockedDays: [0, 6], restockMinute: 8 * 60, selloutMinute: 14 * 60)),
  ]

  static let email = "hello@sugarbin.example"
  static let instagram = "https://instagram.com/example"
  /// The B2B pitch under the machine list.
  static let hostPitch = "Want a Sugar Bin in your lobby, campus, or terminal?"
  static let donationNote = "Unsold pastries are donated to Blanchet House every evening."
}
