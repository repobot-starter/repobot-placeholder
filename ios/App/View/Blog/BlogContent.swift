...
enum BlogContent {
  ...
  static let author = Author(
    ...
    bio:
      "I build small, sturdy software and write down what I learn. Previously at a mapping startup; now independent.",
    initials: "SO")
  ...
  static func allTags(in list: [Post] = posts) -> [String] {
    var seen: [String] = []
    for post in list {
      for tag in post.tags where !seen.contains(tag) {
        seen.append(tag)
      }
    }
    return seen
  ...
  static func sortedPosts(_ list: [Post] = posts) -> [Post] {
