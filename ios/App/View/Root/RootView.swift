...
struct RootView: View {
  ...
  /// The kernel Identity exemplar: sign-in → hydrate → shell, with the global
  ...
  private var uiThemeTokens: UiThemeTokens {
    ...
    let mode = ThemeResolver.resolveMode(preference: preference, systemColorScheme: systemColorScheme)
