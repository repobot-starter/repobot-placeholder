...
/// no API key ever ships in the app. In AI_MODE=local sandboxes the backend
/// returns a simulated session and the component plays scripted replies —
/// the whole surface works without the real model (see docs/ai.md).
