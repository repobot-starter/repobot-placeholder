...
enum QuizContent {
  struct Quiz: Identifiable {
    ...
    let questions: [QuizEngine.Question]
  }

  static let title = "QuizBot"
  static let tagline = "Eight questions. No lifelines. See what sticks."
    ...
    Quiz(
      ...
      questions: [
        QuizEngine.Question(
          ...
          answerIndex: 1,
          explanation:
            "Saturn pulled ahead again — well over 200 confirmed moons, most of them tiny."),
        QuizEngine.Question(
        ...
        QuizEngine.Question(
          ...
          choices: [
            "Molten lava fields", "Rusted iron in the dust", "Thick red clouds",
        ...
        QuizEngine.Question(
          ...
          choices: [
            "Burning gas and oxygen", "Hydrogen and helium", "Molten iron",
        ...
        QuizEngine.Question(
          ...
          answerIndex: 1,
          explanation:
            "Around 109 Earths side by side — and about 1.3 million inside it by volume."),
      ]),
    Quiz(
      id: "how-things-work",
      ...
      questions: [
        QuizEngine.Question(
          ...
          choices: [
            "Infrared heating coils", "It vibrates water molecules with radio waves",
            "Compressed hot air", "Mild radioactivity",
          ],
          answerIndex: 1,
          explanation:
            "Microwaves make water (and fat) molecules oscillate; the friction is the heat."),
        QuizEngine.Question(
          prompt: "What does a refrigerator actually do with heat?",
          choices: [
            "Destroys it", "Converts it to electricity",
            "Moves it from inside to the coils outside", "Stores it in the freezer",
          ],
          answerIndex: 2,
          explanation:
        ...
        QuizEngine.Question(
          ...
          choices: [
            "Radio antennas", "They reduce drag from wingtip vortices", "Lightning protection",
            "Style, mostly",
          ],
          answerIndex: 1,
        ...
        QuizEngine.Question(
          ...
          choices: [
            "Boost horsepower", "Muffle engine noise",
            "Turn harmful exhaust gases into tamer ones", "Recycle unburned fuel into the tank",
          ],
          answerIndex: 2,
          explanation:
        ...
        QuizEngine.Question(
          ...
          choices: [
            "Yeast releases carbon dioxide", "Flour expands when wet", "Trapped steam only",
            "Gluten multiplies",
          ],
          answerIndex: 0,
          explanation:
            "Yeast eats sugars and exhales CO₂; gluten is the balloon skin that holds it."),
        QuizEngine.Question(
          prompt: "Noise-cancelling headphones work by…",
          choices: [
            "Very thick padding", "Playing an inverted copy of the noise",
            "Filtering frequencies with magnets", "A vacuum between the ear cups",
          ],
          answerIndex: 1,
          explanation:
        ...
        QuizEngine.Question(
          ...
          choices: [
            "Grip on the club face", "They reduce aerodynamic drag", "Cheaper to manufacture",
        ...
        QuizEngine.Question(
          ...
          choices: [
            "Stiff steel beams underneath", "Cables in tension hung from towers",
            "Air pressure chambers", "Arches hidden in the roadway",
          ],
          answerIndex: 1,
          explanation:
    ...
    Quiz(
      ...
      questions: [
        ...
        QuizEngine.Question(
          ...
          choices: [
            "Russia & China", "Chile & Argentina", "US & Canada", "Kazakhstan & Russia",
          ],
          answerIndex: 2,
