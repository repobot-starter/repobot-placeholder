...
struct GraphQLClient: GraphQLClientProtocol {
  ...
  func updateUser(input: UpdateUserInput) async throws -> UpdatedUserData {
    let data = try await performMutation(UpdateUserMutation(input: input))
  ...
  func createBillingPortalSession(input: CreateBillingPortalSessionInput) async throws -> BillingPortalSessionData {
    let data = try await performMutation(CreateBillingPortalSessionMutation(input: input))
  ...
  func createSubscriptionCheckoutSession(
    ...
    let data = try await performMutation(CreateSubscriptionCheckoutSessionMutation(input: input))
    return data.createSubscriptionCheckoutSession
  }

  // MARK: Storage

  func createUpload(input: CreateUploadInput) async throws -> UploadSlotData {
    let data = try await performMutation(CreateUploadMutation(input: input))
    return data.createUpload
  }

  func finalizeUpload(input: FinalizeUploadInput) async throws -> FinalizedUploadData {
    let data = try await performMutation(FinalizeUploadMutation(input: input))
    return data.finalizeUpload
  }

  func deleteUpload(input: DeleteUploadInput) async throws -> Bool {
    let data = try await performMutation(DeleteUploadMutation(input: input))
  ...
  func registerPushDevice(input: RegisterPushDeviceInput) async throws -> PushDeviceData {
    let data = try await performMutation(RegisterPushDeviceMutation(input: input))
    return data.registerPushDevice
  }

  func unregisterPushDevice(input: UnregisterPushDeviceInput) async throws -> Bool {
    let data = try await performMutation(UnregisterPushDeviceMutation(input: input))
