...
**Repobot Roastery**, a small-batch coffee roastery example store. It ships
with a complete storefront — roast-of-the-month hero, roast-badged product
grid, tasting notes and origin details on the product page, a pour-over brew
guide, a subscription callout, and an FAQ — all as demo copy the user will
replace with their own. The demo copy lives in section `{% schema %}`
