...
copy of the repobot-shopify-boutique example theme** (an apparel-boutique
storefront on the repobot Shopify standards), and the user's existing theme
...
from this template. Replace the boutique's demo copy and placeholder
sections with the user's real content as you go; do not leave example
storefront copy behind.
...
6. **Do not carry over**: `node_modules`, build output, `.shopify/` state,
