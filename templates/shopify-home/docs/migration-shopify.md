...
copy of the repobot-shopify-home example store**, and the user's existing theme
...
6. **Replace the demo copy.** This repo ships as a home-and-furniture
   example: the room-scene hero, room lookbook, material cards, delivery
   FAQ, and product spec table carry demo content in section schema
   defaults and in `templates/index.json` / `templates/product.json`.
   Overwrite it with the user's real copy; drop example sections their
