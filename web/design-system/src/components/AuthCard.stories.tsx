...
/** Every registered OAuth provider at once — the full button stack. */
export const AllProviders: Story = {
    args: {
        methods: ["google", "apple", "github", "facebook", "discord", "x", "linkedin", "email-code"],
    },
}
...
/**
 * Two-factor challenge: shown after the primary factor succeeds for an
 * identity with MFA enabled (a sign-in handler rejected with
 * MfaRequiredError, or the app deep-linked in from a redirect's
 * #mfa_challenge fragment). The ghost toggle switches to recovery-code entry.
 */
export const MfaChallenge: Story = {
    args: { methods: ["password"], initialView: "challenge", initialEmail: "you@example.com" },
}
