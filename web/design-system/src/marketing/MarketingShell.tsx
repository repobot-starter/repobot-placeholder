...
function Logo({ logo, className }: { logo: MarketingShellNavContent["logo"]; className?: string }) {
    ...
    const marked =
        logo.markSrc === undefined || logo.imageSrc ? (
            stacked
        ) : (
            <span className={styles.logoMarked}>
                <span
                    aria-hidden
                    className={styles.logoMark}
                    style={{
                        WebkitMaskImage: `url("${marketingSrc(logo.markSrc)}")`,
                        maskImage: `url("${marketingSrc(logo.markSrc)}")`,
                    }}
                />
                {stacked}
            </span>
