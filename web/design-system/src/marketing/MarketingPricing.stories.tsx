...
/** Three to five flat prices hung as tags — the price book's groups
 * flattened into one row, each tag in the next spot tone. */
export const PriceTags: Story = {
    args: {
        variant: "price-tags",
        title: "Three prices to know.",
        intro: "Printed, flat, and the same at 116° as at 72°.",
        groups: [
            {
                items: [
                    { name: "Tune-up", price: "$89", note: "Coil rinse, capacitor test, new filter" },
                    { name: "Diagnostic", price: "$0", note: "With any repair" },
                    {
                        name: "New system",
                        price: "$6,900",
                        qualifier: "from",
                        note: "3-ton heat pump, installed",
                    },
                ],
            },
        ],
