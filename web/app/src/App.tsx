...
import PublishedFreeFooter from "./View/Site/PublishedFreeFooter"
...
const PhotographyMusicProofingPage = lazy(() => import("./View/PhotographyMusic/ProofingPage"))
const PhotographyFamilyPage = lazy(() => import("./View/PhotographyFamily/PhotographyFamilyPage"))
const PhotographyFamilyProofingPage = lazy(() => import("./View/PhotographyFamily/ProofingPage"))
...
const WeddingEditionPage = lazy(() => import("./View/WeddingEdition/WeddingEditionPage"))
const WeddingEditionProofingPage = lazy(() => import("./View/WeddingEdition/ProofingPage"))
...
const InteriorsPage = lazy(() => import("./View/Interiors/InteriorsPage"))
const InfluencerPage = lazy(() => import("./View/Influencer/InfluencerPage"))
...
const homePageByPack: Record<PackKey, () => React.ReactElement> = {
    ...
    "photography-family": () => <PhotographyFamilyPage />,
    wedding: () => <WeddingPage />,
    "wedding-edition": () => <WeddingEditionPage />,
    band: () => <BandPage />,
    dj: () => <DjPage />,
    single: () => <SinglePage />,
        ...
        <Suspense fallback={<RouteFallback />}>
            ...
            <Routes>
                ...
                {/* Photography pack pages: the preview route nests them;
                    ...
                    by the photographer, gated by a server-checked access
                    code on /__proofing/room. */}
                ...
                <Route
                    path={`${routes.photography.path}/galleries`}
                    element={<PhotographyPage page="galleries" />}
                />
                <Route path={`${routes.photography.path}/about`} element={<PhotographyPage page="about" />} />
                <Route path={`${routes.photography.path}/book`} element={<PhotographyPage page="book" />} />
                <Route
                ...
                {activePack.key === "photography" ? (
                    <>
                        ...
                        <Route path="/galleries" element={<PhotographyPage page="galleries" />} />
                        <Route path="/about" element={<PhotographyPage page="about" />} />
                        <Route path="/book" element={<PhotographyPage page="book" />} />
                ...
                {/* The music-photography starter: same shape as photography —
                    five public pages, album detail rides ?album= on /work,
                    real session booking on /book (the managed booking
                    domain's appointment mode) above the show-booking form,
                    plus the unlisted, code-gated /proof client proofing room
                    on the platform proofing doors. */}
                ...
                />
                <Route
                    path={`${routes.photographyMusic.path}/galleries`}
                    element={<PhotographyMusicPage page="galleries" />}
                />
                <Route
                ...
                />
                <Route
                    path={`${routes.photographyMusic.path}/proof`}
                    element={<PhotographyMusicProofingPage />}
                />
                {activePack.key === "photography-music" ? (
                    <>
                        <Route path="/work" element={<PhotographyMusicPage page="work" />} />
                        <Route path="/galleries" element={<PhotographyMusicPage page="galleries" />} />
                        <Route path="/about" element={<PhotographyMusicPage page="about" />} />
                        <Route path="/book" element={<PhotographyMusicPage page="book" />} />
                        <Route path="/proof" element={<PhotographyMusicProofingPage />} />
                    </>
                ) : null}
                {/* The family-photography starter: six public pages (album
                    detail rides ?album= on /work), real session booking on
                    /book (the managed booking domain's appointment mode),
                    plus the unlisted, code-gated /proof client proofing
                    room on the platform proofing doors. */}
                <Route path={routes.photographyFamily.path} element={<PhotographyFamilyPage />} />
                <Route
                    path={`${routes.photographyFamily.path}/work`}
                    element={<PhotographyFamilyPage page="work" />}
                />
                <Route
                    path={`${routes.photographyFamily.path}/galleries`}
                    element={<PhotographyFamilyPage page="galleries" />}
                />
                <Route
                    path={`${routes.photographyFamily.path}/investment`}
                    element={<PhotographyFamilyPage page="investment" />}
                />
                <Route
                    path={`${routes.photographyFamily.path}/about`}
                    element={<PhotographyFamilyPage page="about" />}
                />
                <Route
                    path={`${routes.photographyFamily.path}/book`}
                    element={<PhotographyFamilyPage page="book" />}
                />
                <Route
                    path={`${routes.photographyFamily.path}/inquire`}
                    element={<PhotographyFamilyPage page="inquire" />}
                />
                <Route
                    path={`${routes.photographyFamily.path}/proof`}
                    element={<PhotographyFamilyProofingPage />}
                />
                {activePack.key === "photography-family" ? (
                    <>
                        <Route path="/work" element={<PhotographyFamilyPage page="work" />} />
                        <Route path="/galleries" element={<PhotographyFamilyPage page="galleries" />} />
                        <Route path="/investment" element={<PhotographyFamilyPage page="investment" />} />
                        <Route path="/about" element={<PhotographyFamilyPage page="about" />} />
                        <Route path="/book" element={<PhotographyFamilyPage page="book" />} />
                        <Route path="/inquire" element={<PhotographyFamilyPage page="inquire" />} />
                        <Route path="/proof" element={<PhotographyFamilyProofingPage />} />
                    </>
                ) : null}
                {/* The wedding pack: same shape as photography — seven public
                    pages (wedding detail rides ?wedding= on /weddings), real
                    session booking on /book (the managed booking domain's
                    appointment mode), plus the unlisted, code-gated /proof
                    client proofing room on the platform proofing doors. */}
                ...
                <Route path={`${routes.wedding.path}/galleries`} element={<WeddingPage page="galleries" />} />
                ...
                <Route path={`${routes.wedding.path}/book`} element={<WeddingPage page="book" />} />
                ...
                {activePack.key === "wedding" ? (
                    <>
                        ...
                        <Route path="/galleries" element={<WeddingPage page="galleries" />} />
                        <Route path="/packages" element={<WeddingPage page="packages" />} />
                        <Route path="/about" element={<WeddingPage page="about" />} />
                        <Route path="/book" element={<WeddingPage page="book" />} />
                        <Route path="/inquire" element={<WeddingPage page="inquire" />} />
                        <Route path="/proof" element={<WeddingProofingPage />} />
                    </>
                ) : null}
                {/* The Late Edition (photography category's tabloid wedding
                    pack): five public pages (one roll's contact sheet rides
                    ?roll= on /weddings) plus the unlisted, code-gated /proof
                    client proofing room on the platform proofing doors. */}
                <Route path={routes.weddingEdition.path} element={<WeddingEditionPage />} />
                <Route
                    path={`${routes.weddingEdition.path}/weddings`}
                    element={<WeddingEditionPage page="weddings" />}
                />
                <Route
                    path={`${routes.weddingEdition.path}/prices`}
                    element={<WeddingEditionPage page="prices" />}
                />
                <Route
                    path={`${routes.weddingEdition.path}/about`}
                    element={<WeddingEditionPage page="about" />}
                />
                <Route
                    path={`${routes.weddingEdition.path}/inquire`}
                    element={<WeddingEditionPage page="inquire" />}
                />
                <Route
                    path={`${routes.weddingEdition.path}/proof`}
                    element={<WeddingEditionProofingPage />}
                />
                {activePack.key === "wedding-edition" ? (
                    <>
                        <Route path="/weddings" element={<WeddingEditionPage page="weddings" />} />
                        <Route path="/prices" element={<WeddingEditionPage page="prices" />} />
                        <Route path="/about" element={<WeddingEditionPage page="about" />} />
                        <Route path="/inquire" element={<WeddingEditionPage page="inquire" />} />
                        <Route path="/proof" element={<WeddingEditionProofingPage />} />
                    </>
                ) : null}
                ...
                {/* The interiors pack: five public pages (the design
                    category's interior-design portfolio starter — the
                    projects-domain flagship). */}
                <Route path={routes.interiors.path} element={<InteriorsPage />} />
                <Route
                    path={`${routes.interiors.path}/portfolio`}
                    element={<InteriorsPage page="portfolio" />}
                />
                <Route
                    path={`${routes.interiors.path}/offerings`}
                    element={<InteriorsPage page="offerings" />}
                />
                <Route path={`${routes.interiors.path}/about`} element={<InteriorsPage page="about" />} />
                <Route path={`${routes.interiors.path}/contact`} element={<InteriorsPage page="contact" />} />
                {activePack.key === "interiors" ? (
                    <>
                        {/* NOT /services: that path is the services pack's
                            preview route — the studio's menu lives at
                            /offerings (the care pack's /what-we-treat
                            reasoning). */}
                        <Route path="/portfolio" element={<InteriorsPage page="portfolio" />} />
                        <Route path="/offerings" element={<InteriorsPage page="offerings" />} />
                        <Route path="/about" element={<InteriorsPage page="about" />} />
                        <Route path="/contact" element={<InteriorsPage page="contact" />} />
                    </>
                ) : null}
                {/* The influencer pack: five public pages (the creator
                    category's personal-brand starter — the flagship of the
                    links and looks content domains). */}
                <Route path={routes.influencer.path} element={<InfluencerPage />} />
                <Route path={`${routes.influencer.path}/looks`} element={<InfluencerPage page="looks" />} />
                <Route path={`${routes.influencer.path}/links`} element={<InfluencerPage page="links" />} />
                <Route path={`${routes.influencer.path}/about`} element={<InfluencerPage page="about" />} />
                <Route
                    path={`${routes.influencer.path}/contact`}
                    element={<InfluencerPage page="contact" />}
                />
                {activePack.key === "influencer" ? (
                    <>
                        <Route path="/looks" element={<InfluencerPage page="looks" />} />
                        <Route path="/links" element={<InfluencerPage page="links" />} />
                        <Route path="/about" element={<InfluencerPage page="about" />} />
                        <Route path="/contact" element={<InfluencerPage page="contact" />} />
                    </>
                ) : null}
