        ...
        <main className={styles.page}>
            ...
            <section className={styles.hero} id="top">
                <div>
                    ...
                    <BuyControls priceLabel={priceLabel} productKey={product?.key} />
            ...
            <section className={styles.buyBand} id="buy">
                <div className={styles.buyBandInner}>
                    ...
                    <BuyControls
                        ...
                        buttonClassName={styles.buyBandButton}
                    />
                </div>
            </section>
...
function BuyControls(props: {
    ...
    /** Which catalog product to buy; undefined (still loading) buys the storefront default. */
                ...
                variables: {
                    input: {
                        ...
                        fields: {
                            ...
                            // this build's mount path (demo previews live under
                            // /games/<key>/); plain origin everywhere else.
