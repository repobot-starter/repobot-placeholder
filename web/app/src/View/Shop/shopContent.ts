...
export const shopContent = {
    ...
    /**
     * The success page's download link for the session-gated delivery file
     * (firebase/functions/delivery/<productKey>/); only shown when the
     * purchased product has one.
     */
    deliveryLinkLabel: "Download your bonus letter",
