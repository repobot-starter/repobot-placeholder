import { buildDeliveryUrl, derivePaymentsEndpoint } from "@base/core"
            ...
            <div className={styles.card}>
                {isMissing ? (
                    ...
                    <>
                        ...
                        {session.deliveryAvailable && (
                            // Session-gated delivery: the payments kernel re-verifies
                            // payment server-side before streaming the file.
                            <a
                                className={styles.payButton}
                                href={buildDeliveryUrl(
                                    derivePaymentsEndpoint(import.meta.env.VITE_GRAPHQL_URL),
                                    session.id,
                                )}
                                download
                            >
                                {shopContent.deliveryLinkLabel}
                            </a>
                        )}
