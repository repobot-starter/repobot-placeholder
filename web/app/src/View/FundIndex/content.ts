...
export const contact = {
    ...
    confirmation:
        "Received. A partner reads everything in our sectors within a week — if it prices, you'll hear from us.",
    /**
     ...
     * discipline: the two lines the body asks for, a link to the deck,
     * nothing else.
     */
    fields: [
        ...
        { name: "deck", label: "Deck link", placeholder: "https://…" },
        {
            name: "message",
            label: "What you're building, and the hard part",
