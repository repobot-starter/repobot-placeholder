 ...
 * token contract, so it wears the pack's register (the snapshot fridge
 * door: cream paper, condensed caps, marker red) and restyles with the
 * platform's theme controls. Deliberately quieter than the healthcare
 * widget it is modeled on — hairline card, display heading, generous air.
 */
