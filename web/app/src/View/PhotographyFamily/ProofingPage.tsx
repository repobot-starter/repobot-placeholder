...
export default function ProofingPage(): React.ReactElement {
    ...
    return (
        <MarketingPage preset={PACK_REGISTERS["photography-family"]}>
            ...
            />
            <div className={styles.page[proofing.voice]}>
                {slug === "" ? (
...
function AccessGate({
    ...
    return (
        <div className={styles.gate}>
            <form className={styles.gateCard[proofing.voice]} onSubmit={submit}>
                <span className={styles.studioMark[proofing.voice]}>{photographer.name}</span>
                <h1 className={styles.gateTitle[proofing.voice]}>{proofing.gate.title}</h1>
                ...
                <div className={styles.gateForm}>
                    ...
                    />
                    <button type="submit" className={styles.gateButton[proofing.voice]} disabled={checking}>
    ...
    return (
        <>
            <header className={styles.header}>
                <span className={styles.studioMark[proofing.voice]}>{photographer.name}</span>
                <h1 className={styles.title[proofing.voice]}>{room.title}</h1>
