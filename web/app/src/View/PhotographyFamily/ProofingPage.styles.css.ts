 ...
 * it inherits the pack's `heirloom` register (warm ivory, champagne
 * hairlines, Fraunces headings). Deliberately quieter than the public
...
export const gateError = style({
    fontSize: 13.5,
    // The register's own accent (heirloom's botanical green) — never a
