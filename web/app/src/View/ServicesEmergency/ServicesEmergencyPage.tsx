...
import { booking, business, codeAppointments, home, request } from "./content"
...
export default function ServicesEmergencyPage({
    ...
    const appointments = useAppointmentsContent(codeAppointments, "services-emergency")
        ...
        return (
            <>
                ...
                {/* Service requests post formKey "service-request" through
                    ...
                    mode 2 on the managed booking kernel for the visits that
                    can WAIT (urgent-but-scheduled calls and inspections);
                    true emergencies stay with the 24/7 line. */}
                <LandingRenderer
                    config={resolved}
