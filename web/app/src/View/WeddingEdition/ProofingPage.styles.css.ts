 ...
 * inherits the pack's `tabloid` register. Deliberately quieter than the
...
export const gateError = style({
    fontSize: 13.5,
    // The register's own accent (tabloid's fire-engine red), not a forked
    // constant: photography's copy of this file kept a rust literal, and
    // literals are how two packs end up wearing the same color.
