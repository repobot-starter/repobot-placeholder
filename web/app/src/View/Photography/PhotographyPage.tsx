...
import { aboutLanding, homeLanding, inquireLanding, workLanding } from "./photographyLanding"

export type PhotographyPageKind = "home" | "work" | "about" | "inquire"

/**
 * The photography pack's site (docs/landing.md, "The photography-grade
 * set"): four kernel-composed pages from one `content.ts`. When the pack
 * is active it owns /, /work, /about, and /inquire; on the preview route
 * the same pages nest under /photography/*. Album detail rides `?album=`
 * on the work page (the BlogBot `?post=` pattern) so a new album is a
 * content edit, never a route edit.
 *
