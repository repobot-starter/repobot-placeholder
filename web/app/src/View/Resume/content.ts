...
export interface Project {
     ...
     * Leave "" until it's a real page: the shipped demo destinations are
...
// cards render unlinked until you paste your real pages. The field stays
// present (never omitted) so the workspace Content panel can fill it in —
// the content service edits existing literals, it cannot add properties.
...
export const links: ProfileLink[] = [
    ...
    { label: "LinkedIn", value: "linkedin.com/in/amarasethi", url: "" },
    { label: "Website", value: "amarasethi.example", url: "" },
    { label: "Notes", value: "amarasethi.example/notes", url: "" },
]
