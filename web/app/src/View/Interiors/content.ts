 ...
 *
 * `home.layout` picks the home page's composition: `gallery` (this
 * studio's) is the photo-led stack — the masthead hero, the featured-work
 * rail, the service tiles, the numbers, one voice, and a closing banner;
 * `catalog` opens on the split cover and runs the numbered services
 * strip, the before-and-after case files, the catalog of pieces, the
 * process, the fees, the questions, and the consultation form. Sections a
 * layout doesn't use (`caseStudies`, `pieces`, `fees`) can stay empty.
 *
...
export const landingCopy = {
    ...
    offeringsBannerBody: "Book a free discovery call — twenty minutes, real numbers, no pitch.",
...
/** The `catalog` home's before-and-after case files — unused by the `gallery` layout. */
...
/** The `catalog` home's catalog of pieces — unused by the `gallery` layout. */
export const pieces = {
    kicker: "",
    title: "",
...
/** The fee board — empty, so /offerings keeps its services, process, and questions. */
export const fees = {
    kicker: "",
    title: "",
    intro: "",
...
export const contact = {
    ...
    /** The `catalog` home's consultation form heading — unused by the `gallery` layout. */
