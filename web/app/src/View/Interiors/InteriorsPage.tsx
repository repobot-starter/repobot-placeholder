...
import { booking, codeAppointments, contact, home, studio } from "./content"
import {
    aboutLanding,
    contactLanding,
    homeLanding,
        ...
        return (
            <>
                <PageMeta
                    ...
                    description={`The portfolio of ${studio.name} — whole homes, kitchens and baths, commercial rooms, and styling, ${studio.location}.`}
                />
        ...
        return (
            <>
                <PageMeta
                    ...
                    siteName={studio.name}
                    description={`How ${studio.name} works: full-service design, kitchen & bath design, and furnishing & styling — with honest numbers up front.`}
                />
                <LandingRenderer config={resolved} />
            </>
        )
