...
export const landingCopy = {
    ...
    nav: { providers: "Providers", services: "Services", newPatients: "New patients" },
    /** The booking ask — the shell CTA and every page's primary CTA. */
    bookCtaLabel: "Book an appointment",
    home: {
        secondaryCtaLabel: "Meet the providers",
        servicesKicker: "What we treat",
        servicesHeading: "Care for the whole family",
        providersKicker: "Your providers",
        providersHeading: "The people behind the door",
        reviewsKicker: "From our patients",
        bannerTitle: "Ready when you are.",
    },
    ...
    visitHeadline: "On Alder Street, in the heart of downtown.",
    providersPage: {
    ...
    servicesPage: {
        ...
        bannerTitle: "Same-day slots most mornings.",
    },
    newPatientsPage: {
        ...
        kicker: "New patients",
        bannerTitle: "New-patient visits are 45 minutes, on purpose.",
    },
    bookPage: {
        steps: [
            {
                title: "Pick a visit type",
                description: "New patient, follow-up, or annual physical — the length is built in.",
            },
            {
                title: "Choose a provider and time",
                description: "Real openings from each provider's actual week, up to four weeks out.",
            },
            {
