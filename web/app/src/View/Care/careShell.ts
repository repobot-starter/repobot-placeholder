...
import { landingCopy, practice } from "./content"
...
// Labels come from the content module's landingCopy (a remix seed retrades
// them); the paths are the pack's structure and never move with a seed.
const CANONICAL_LINKS = [
    { label: landingCopy.nav.providers, path: "/providers" },
    // The services page lives at /what-we-treat: /services is the services
    // pack's preview route, which every checkout keeps.
    { label: landingCopy.nav.services, path: "/what-we-treat" },
    { label: landingCopy.nav.newPatients, path: "/new-patients" },
] as const
