...
export interface LinkProfile {
    ...
    bio: string
    /**
     * Seeds the avatar's generative mark (raw emoji read as template
     * filler, so this never renders as a character). Change it to reroll
     * the artwork; swap in a real avatar by editing LinkPage.tsx.
     */
    avatarEmoji: string
    location: string
}
...
export interface LinkItem {
    /**
     * Seeds the row's generative mark on the left edge (rendered as
     * seeded artwork, never as the raw character). Change it to reroll.
     */
    emoji: string
    label: string
...
// Bare platform homepages render as inert badges (LinkPage links a chip
// only when the URL has a profile path) — replace with your real profile
// URLs, e.g. "https://github.com/yourhandle", to make them live.
