    ...
    return {
        ...
        sections: [
            ...
            },
            {
                ...
                type: "cta-banner",
                content: {
                    title: "Your gallery starts with your date.",
                    cta: { label: "Check your date", href: `${basePath}/inquire` },
                },
            },
        ],
        ...
        sections: [
            ...
            // (WeddingPage `sectionTrailers`).
            {
                ...
                content: {
                    ...
                    body: "The calendar shows the studio's actual weekday openings, a few weeks out. Hold a time and it's yours — the confirmation email carries a one-click cancel link, and rescheduling is free up to 48 hours before we meet.",
                    bullets: [
                    ...
                    media: imageMedia(albums[0].images[5]),
