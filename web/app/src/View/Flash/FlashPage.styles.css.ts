...
const line = "#e2e0ef"
const violet = "var(--pack-accent, #5b4fc7)"
const violetSoft = "var(--pack-accent-soft, #eceafb)"
const amber = "#e5a33d"
const green = "#3e6b4f"
const red = "#a04b3c"

const serif = '"Fraunces", Georgia, serif'
const sans = 'var(--pack-font, -apple-system, "SF Pro Text", "Segoe UI", Roboto, sans-serif)'
