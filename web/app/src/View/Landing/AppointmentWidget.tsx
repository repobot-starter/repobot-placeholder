...
export function AppointmentWidget({
    ...
    statusLabels = { new: "New patient", returning: "Returning patient" },
    privacyNote = "Just the basics to hold your time — no health questions here, ever. Anything about your visit stays between you and your care team at the office.",
}: {
    appointments: AppointmentsContent
    headline?: string
    intro?: string
    /**
     * The new/returning select's visible copy. The clinical default fits
     * the healthcare packs; the trades packs re-voice it ("New customer")
     * without touching the wire value the booking domain stores.
     */
    statusLabels?: { new: string; returning: string }
    /**
     * The line under the form. The clinical default is the healthcare
     * packs' promise; the trades packs re-voice it the same way as
     * statusLabels — the form itself stays exactly as empty.
     */
    privacyNote?: string
                    ...
                    <>
                        ...
                        >
                            ...
                            >
                                ...
                                <option value="RETURNING">{statusLabels.returning}</option>
                            </select>
