/**
 * Opening-hours logic — the computable heart of a local business site,
 * shared by the local-business packs (menu, services). Pure and
 * deterministic (the current time is always passed in), and mirrored in
 * MenuHours.swift and MenuHours.kt so the "Open now" badge agrees on
 * every platform.
 *
