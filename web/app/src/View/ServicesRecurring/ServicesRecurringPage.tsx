...
import { book, booking, business, codeAppointments, home } from "./content"
...
export default function ServicesRecurringPage({
    ...
    const appointments = useAppointmentsContent(codeAppointments, "services-recurring")
        ...
        return (
            <>
                ...
                {/* Booking requests post formKey "booking-request" through
                    ...
                    mode 2 on the managed booking kernel (the walkthrough
                    and the first service visit, capacity-1): real seats on
                    a deploy, sandbox simulation in the workspace. */}
                <LandingRenderer
                    config={resolved}
