...
export const landingCopy = {
    ...
    aboutBullets: [
        "Bonded & insured — every cleaner background-checked",
 ...
 *
 * The subscription trade books the front of the relationship: the
 * walkthrough that prices the home, and the first service visit that
 * starts the rhythm. The standing schedule itself lives with the office —
 * only these two visit kinds go on the public calendar. One provider —
 * the founder still walks every new home — with weekday windows.
 */
    ...
    types: [
        {
            ...
            durationMinutes: 45,
            description:
                "A walk through the home together — we measure, note the priorities, and quote a flat rate.",
        },
        {
            ...
            durationMinutes: 120,
            description:
                "The first full visit — deep, top to bottom, so the standing schedule starts from clean.",
        },
    ],
    providers: [
        {
...
export const booking: {
    ...
    intro: "Book the walkthrough or your first service visit directly — pick a time and you'll get a confirmation with a one-click cancel link. Prefer to write first? The form below reaches the same team.",
