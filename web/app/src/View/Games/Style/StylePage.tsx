...
function readBestScore(): number {
    return readStoredNumber(BEST_SCORE_KEY, 0)
}
    ...
    const dismissVerdict = (): void => {
        if (round + 1 >= ROUNDS_PER_SEASON) {
            if (seasonTotal > bestScore) {
                ...
                writeStoredNumber(BEST_SCORE_KEY, seasonTotal)
            }
            setPhase("seasonOver")
        } else {
            setRound(round + 1)
                ...
                <div className={styles.layout}>
                    <aside className={styles.panelColumn}>
                        ...
                        <section className={styles.panelBrand}>
                            <div className={styles.brandName}>STYLE</div>
                            ...
                            {phase === "idle" && (
                                <div className={styles.stageOverlay}>
                                    <div className={styles.verdictCard}>
                                        <div className={styles.overlayTitle}>✨ STYLE ✨</div>
