...
function loadProgress(): Progress {
    const saved = readStoredJson<Progress | null>(PROGRESS_KEY, null)
    if (saved && typeof saved.unlocked === "number" && Array.isArray(saved.stars)) {
        return {
...
export default function CodePage(): React.ReactElement {
    ...
    useEffect(() => {
        writeStoredJson(PROGRESS_KEY, progress)
    }, [progress])
                ...
                <div className={styles.layout}>
                    <aside className={styles.panelColumn}>
                        ...
                        <section className={styles.panelBrand}>
                            <div className={styles.brandName}>CODE</div>
