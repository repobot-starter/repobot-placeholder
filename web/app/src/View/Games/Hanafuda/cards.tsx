// Inline SVG art for all 48 hanafuda cards in flat monochrome style: black
// ink and greys on near-white, matching the pack's black/white modern look.
// The traditional hues map to tones — crimson and gold become mid greys, the
// aotan ribbons a deeper grey — so ribbon families stay distinguishable by
// tone plus their existing markings (poetry script, the aotan stripe). Every
// card is a composition of its month's flora plus the slot's special motif,
// so each is visually distinct and month-recognizable at a glance.
//
...
const INK = "#151517"
const RED = "#8f8f96"
const RED_DEEP = "#6b6b73"
const GOLD = "#a1a1aa"
const GOLD_PALE = "#d4d4d8"
const CREAM = "#fcfcfc"
const WHITE = "#ffffff"
const PURPLE = "#55555c"
const BLUE = "#3a3a41"
...
/** The shared card back: near-black with a pale blossom roundel. */
