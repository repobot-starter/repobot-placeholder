...
const bg = "#0a0512"
const panelBg = "#150a24"
const panelEdge = "#3c2454"
...
/** Full-viewport pit-wall wrapper (owns the night-race background). */
export const page = style({
    ...
    background: bg,
    backgroundImage:
        "radial-gradient(circle at 15% 15%, rgba(255, 107, 129, 0.08), transparent 45%), " +
        "radial-gradient(circle at 85% 85%, rgba(87, 200, 255, 0.08), transparent 45%)",
    color: text,
    userSelect: "none",
...
export const cockpit = style({
    ...
    borderRadius: 10,
    boxShadow: "0 0 40px rgba(255, 107, 129, 0.14), inset 0 0 20px rgba(0, 0, 0, 0.6)",
    overflow: "hidden",
})
...
export const logo = style({
    ...
    fontSize: 20,
    background: "linear-gradient(90deg, #ff6b81, #ffd166)",
    WebkitBackgroundClip: "text",
    backgroundClip: "text",
    color: "transparent",
    filter: "drop-shadow(0 0 8px rgba(255, 107, 129, 0.5))",
    marginRight: "auto",
})
...
export const barFill = style({
    height: "100%",
    background: `repeating-linear-gradient(90deg, ${amber} 0, ${amber} 6px, transparent 6px, transparent 9px)`,
...
export const viewport = style({
    ...
    borderRadius: 8,
    boxShadow: "0 0 24px rgba(255, 107, 129, 0.3), inset 0 0 60px rgba(0, 0, 0, 0.8)",
    overflow: "hidden",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
...
export const modalTitle = style({
    ...
    fontSize: 26,
    color: red,
    textShadow: "0 0 14px rgba(255, 107, 129, 0.7)",
})
