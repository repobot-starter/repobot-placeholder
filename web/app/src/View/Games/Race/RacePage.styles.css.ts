...
// Width capped by viewport height so the portrait road plus chrome never
// scrolls: road width = (available height) * (420 / 720), plus the side rail.
export const frame = style({
    display: "flex",
    flexDirection: "column",
    width: "min(880px, 100%, calc((100vh - 176px) * (420 / 720) + 298px))",
    gap: 18,
})
...
export const statWide = style([stat, { gridColumn: "1 / -1" }])
