 ...
 */
import { formatMinorUnits } from "@base/core"
...
/** "$14" / "$9.50" — trims trailing zero cents. Thin wrapper over the kernel util. */
export function formatPrice(priceCents: number): string {
    return formatMinorUnits(priceCents, "usd", { trimWholeCents: true })
}
