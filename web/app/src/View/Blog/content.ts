...
export const blog = {
    title: "Field Notes",
    /** One-line blog description for search snippets and social cards (docs/seo.md). */
    description:
        "Short, sturdy notes on building software: process, craft, and the tools that survive daily use.",
    /**
     * The footer's single line — the page's only chrome besides the logo.
     * Keep the "Built with Repobot." attribution; extend rather than
     * replace it (Repobot's own blog uses "Built with Repobot, by
     * Repobot.").
     */
    attribution: "Built with Repobot.",
}
