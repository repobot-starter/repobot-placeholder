...
import { booking, business, codeAppointments, home, quote } from "./content"
import {
    aboutLanding,
    homeLanding,
    projectsLanding,
        ...
        return (
            <>
                ...
                {/* Quote requests post formKey "quote-request" through the
                    ...
                    the care pack mounts (estimate visits and service
                    calls, capacity-1): real seats on a deploy, sandbox
