...
export const home = {
    ...
    featuredProjects: [projects[0], projects[1]] as Project[],
 ...
 * booking widget and Manage editor open on the painting company's own
    ...
    types: [
        {
            ...
            durationMinutes: 60,
            description:
                "A walkthrough of the job — we measure, listen, and follow up with a fixed written quote.",
        },
        {
            typeId: "service-call",
            name: "Service call",
            durationMinutes: 120,
            description:
                "A scheduled block for touch-ups and small jobs — scuffed trim, one-room refreshes, handled.",
        },
    ],
    providers: [
        {
            providerId: "tom-barrera",
            name: "Tom Barrera",
            windows: [
