...
export const routes = defineRoutes({
    ...
    /** The photography category's family-photographer starter previews here. */
    photographyFamily: { path: "/photography-family" },
    wedding: { path: "/wedding" },
    /** The photography category's tabloid wedding starter (The Late Edition) previews here. */
    weddingEdition: { path: "/wedding-edition" },
    ...
    estate: { path: "/estate" },
    /** The design category's interior-design portfolio starter previews here. */
    interiors: { path: "/interiors" },
    /** The creator category's personal-brand starter previews here. */
