...
export interface MarketingPageSectionEntry {
     ...
     * "first-word", "none" (pure typography), "full-stop" (only the
     * closing punctuation), or "last-line" (the final line of a headline
     * written with line breaks). Unknown values fall back
