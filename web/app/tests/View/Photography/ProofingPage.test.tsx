...
import { demoProofingAlbums, photoId, photographer, proofing } from "../../../src/View/Photography/content"
import ProofingPage from "../../../src/View/Photography/ProofingPage"

const album = demoProofingAlbums[0]
const copy = proofing.selection
...
describe("ProofingPage (client proofing room)", () => {
    ...
    it("selects frames, persists picks locally, and posts them to the proofing door", async () => {
        ...
        const sendButton = screen.getByRole("button", { name: copy.sendCta })
        ...
        fireEvent.click(screen.getByRole("button", { name: copy.sendCta }))
        ...
        renderProofing()
        expect(await screen.findByText(copy.sentTitle)).toBeTruthy()
        fireEvent.click(screen.getByRole("button", { name: copy.reopenCta }))
        expect(screen.getByText("2 photographs selected")).toBeTruthy()
    })
