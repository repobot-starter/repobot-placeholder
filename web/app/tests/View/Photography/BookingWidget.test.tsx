...
import { BookingWidget } from "../../../src/View/Photography/BookingWidget"
import { booking, codeAppointments } from "../../../src/View/Photography/content"

/**
 * The photography /book widget fronts each session card with a real
 ...
 * previews served under /previews/<pack>/ resolve `/photography/…` against
 * the bundle, not the host origin. A raw `<img src={image.src}>` is the
 * broken-icon bug this suite pins.
 */
describe("photography BookingWidget session cards", () => {
    beforeEach(() => {
        localStorage.clear()
    })
