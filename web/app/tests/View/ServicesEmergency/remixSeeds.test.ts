...
import electricCatalog from "../../../../../packs/services-electric/catalog.json"
import hvacCatalog from "../../../../../packs/services-hvac/catalog.json"
...
const seeds: { name: string; module: ContentModule; publicPrefix: string; catalog: RemixCatalog }[] = [
    { name: "electric", module: electric, publicPrefix: "/services-electric/", catalog: electricCatalog },
    { name: "hvac", module: hvac, publicPrefix: "/services-hvac/", catalog: hvacCatalog },
]
...
describe.each(seeds)("emergency $name remix seed", ({ module, publicPrefix, catalog }) => {
