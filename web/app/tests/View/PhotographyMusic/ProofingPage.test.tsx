...
import { demoProofingAlbums, photoId, photographer } from "../../../src/View/PhotographyMusic/content"
import ProofingPage from "../../../src/View/PhotographyMusic/ProofingPage"
...
describe("PhotographyMusic ProofingPage (client proofing room)", () => {
    beforeEach(() => {
        localStorage.clear()
