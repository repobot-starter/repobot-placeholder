...
import lawncareCatalog from "../../../../../packs/services-lawncare/catalog.json"
import pestCatalog from "../../../../../packs/services-pest/catalog.json"
...
const seeds: { name: string; module: ContentModule; publicPrefix: string; catalog: RemixCatalog }[] = [
    { name: "lawncare", module: lawncare, publicPrefix: "/services-lawncare/", catalog: lawncareCatalog },
    { name: "pest", module: pest, publicPrefix: "/services-pest/", catalog: pestCatalog },
]
...
describe.each(seeds)("recurring $name remix seed", ({ module, publicPrefix, catalog }) => {
