...
import { links, looks } from "../../../src/View/Influencer/content"
...
const document = influencerCatalog.landing
...
describe("influencer catalog landing seed", () => {
    ...
    it("reproduces each page's code skeleton exactly", () => {
        ...
        expect(applySitePageDocument(looksLanding(""), "looks", document)).toEqual(looksLanding(""))
        expect(applySitePageDocument(linksLanding(""), "links", document)).toEqual(linksLanding(""))
