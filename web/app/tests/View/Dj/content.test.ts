...
describe("dj content", () => {
    ...
    it("keeps mix indexes unique, descending, and every mix playable", () => {
        ...
        for (const mix of mixes) {
            ...
            // Mixes carry a demo-loop KEY (content files stay pure data for
            // the workspace content service); the playable shape is asserted
            // through the same merge the pages run.
            const playable = withDemoLoop(mix)
