...
import { photoId, photographer, proofingAlbums } from "../../../src/View/Wedding/content"
import ProofingPage from "../../../src/View/Wedding/ProofingPage"
...
describe("Wedding ProofingPage (client proofing room)", () => {
    beforeEach(() => {
        localStorage.clear()
    ...
    it("selects frames, persists picks locally, and sends them through the forms pipeline", async () => {
        ...
        fireEvent.change(screen.getByRole("textbox", { name: /anything to add/i }), {
            target: { value: "The jetty one, printed large." },
        })
        ...
        expect(body.fields.note).toBe("The jetty one, printed large.")
    ...
    it("keeps proofing rooms off the public site chrome", () => {
        ...
        // public pages (/weddings, /packages, /inquire) are not linked here.
