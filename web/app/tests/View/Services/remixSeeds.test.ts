...
import landscapeCatalog from "../../../../../packs/services-landscape/catalog.json"
import paintingCatalog from "../../../../../packs/services-painting/catalog.json"
...
const seeds: { name: string; module: ContentModule; publicPrefix: string; catalog: RemixCatalog }[] = [
    {
        name: "landscape",
        module: landscape,
        publicPrefix: "/services-landscape/",
        catalog: landscapeCatalog,
    },
    { name: "painting", module: painting, publicPrefix: "/services-painting/", catalog: paintingCatalog },
]
...
describe.each(seeds)("services $name remix seed", ({ module, publicPrefix, catalog }) => {
