...
dependencies {
    ...
    // FCM without the google-services plugin: the kernel cannot commit a tenant
    // google-services.json, so FirebaseApp is initialized programmatically from
    // the stamped FCM_* config values (see components/PushComponent.kt).
