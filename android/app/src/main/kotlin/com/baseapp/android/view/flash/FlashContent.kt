 ...
 * unique within a deck (they double as stable identifiers for saved
 * progress).
 */
object FlashContent {
    ...
    const val TITLE = "FlashBot"
    const val TAGLINE = "A few honest minutes a day. The boxes do the rest."
