...
import com.baseapp.android.update.UpdateStore
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Sideloaded dev builds carry an update-channel URL; one best-effort
        // check per launch offers newer builds in-app (all packs — this is
        // platform infrastructure, not an app-backend call).
        lifecycleScope.launch {
            UpdateStore.checkOnce(appConfig.updateChannelUrl)
        }
