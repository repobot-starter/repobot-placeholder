...
declare module "mocha" {
    export interface Context {
        ...
        quickBooksHelper: QuickBooksTestHelper
        cfoHelper: CfoTestHelper
        creditHelper: CreditTestHelper
        flowHelper: FlowTestHelper
        entryHelper: EntryTestHelper
        songsHelper: SongsTestHelper
        pitchHelper: PitchTestHelper
        driveHelper: DriveTestHelper
