import {
    ...
    GqlRemoveProjectMemberInput,
    GqlUpdateProjectInput,
    GqlUpdateProjectMemberInput,
    GqlUser,
...
export class ProjectTestHelper extends BaseTestHelper {
    ...
    /**
     * Changes a member's role as the given user, who must be an OWNER of the
     * membership's project.
     */
    async updateProjectMember(
        input: GqlUpdateProjectMemberInput,
        user: GqlUser,
    ): Promise<GqlProjectMembership> {
        return await executeGqlAt(
            this.server,
    ...
    /**
     * Removes a member as the given user, who must be an OWNER of the
     * membership's project.
     */
    async removeProjectMember(input: GqlRemoveProjectMemberInput, user: GqlUser): Promise<boolean> {
        return await executeGqlAt(
            this.server,
